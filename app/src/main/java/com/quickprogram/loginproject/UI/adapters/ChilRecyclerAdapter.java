...
import com.quickprogram.loginproject.UI.viewHolders.ChildViewHolder;

import java.util.List;

public class ChilRecyclerAdapter extends RecyclerView.Adapter<ChildViewHolder>{
    List<Presupuesto> items;
    private final OnItemChildClickListener onItemChildClickListener;
    public ChilRecyclerAdapter(List<Presupuesto> items, OnItemChildClickListener onItemChildClickListener) {
        this.items = items;
